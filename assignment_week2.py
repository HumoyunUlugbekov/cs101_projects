...
days=int(input('Please enter your days exercisd in past 30 days: '))
average_duration=int(input('Please enter your average duration per session(minutes): '))
push_ups=int(input('Please enter your push-ups in one set: '))
squats=int(input('Please enter your squats in one set: '))
